			...
			<div class="card">
				...
				<div class="card-body">
					<blockquote class="blockquote mb-0">
						<form method="post" action="<?= base_url('pegawai/addpegawaitu'); ?>">
...
<!--								<label for="exampleFormControlSelect1">Jabatan</label>-->
							...
							<div class="form-group">
								<input type="text" class="form-control" id="bagian" name="bagian" value="TU" readonly>
							</div>
							<div class="row">
								<div class="col-3">
									<a href="<?= base_url('pegawai') ?>" class="btn btn-secondary btn-icon-split">

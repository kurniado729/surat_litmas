...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-3">
					<a href="<?= base_url('pegawai/addpegawaibka'); ?>" class="btn btn-primary btn-icon-split mb-3">
				...
				<div class="col-7">
					<div class="row">
						<div class="col">
							<form action="<?= base_url('pegawai/searchpegawaibka') ?>" method="post">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="<?= base_url('pegawai/deletepegawaibka/' . $p['id_pegawai']); ?>" class="btn btn-danger btn-circle tombol-hapus" data-toggle="tooltip" data-placement="top" title="Hapus">
	...
	<?php if($this->uri->segment(2) == 'searchpegawaibka'): ?>
